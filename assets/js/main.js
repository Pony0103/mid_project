...
$(document).ready(function() {
	...
	$('#groups-btn').on('click', function(e) {
		e.preventDefault();
		var $groupsContent = $('#groups-content');
		
		$groupsContent.toggleClass('active');
		
		$(this).text($groupsContent.hasClass('active') ? 'Hide Groups' : 'Groups');
	...
	$('#results-btn').on('click', function(e) {
		...
		$resultsContent.toggleClass('active');
		
		$(this).text($resultsContent.hasClass('active') ? 'Hide Results' : 'Results');
 ...
 document.getElementById('day-selector').addEventListener('change', function() {
	// 先隱藏所有天數的內容
	document.querySelectorAll('.daily-select').forEach(function(elem) {
